...
The jet has a measured velocity different of XXX from TripleSpec spectra XXX
though we may not want to report that here?

There is a shadowed disk system at 5:35:14.692 -5:22:20.36.  It is most evident
in the [Fe II] filter, but is seen in the \hh and Ks filters as well.  The bright
features perpendicular to the shadow are therefore most likely from reflected
continuum light.  The shadowing occurs at position angle 99\deg.  
